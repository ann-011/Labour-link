...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE register SET fname=?, address=?, skills=?, job_title=?, work_experience=?, location=? WHERE email=?";
    ...
    // Bind parameters
    $stmt->bind_param("sssssss", $name, $address, $skill, $job_title, $work_experience, $location, $_SESSION['email']);
...
<head>
    ...
    <style>
        body {
            ...
            background-color: #e6ffe6; /* Background color set to #e6ffe6 */
            color: #333;
            display: flex;
    ...
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
            <div class="form-group">
                ...
                <input type="text" id="name" name="name" value="<?php echo htmlspecialchars($user["fname"]); ?>" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" id="work_experience" name="work_experience" value="<?php echo htmlspecialchars($user["work_experience"]); ?>" required>
            </div>
            <div class="form-group">
