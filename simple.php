...
<body>
  <div class="container">
    ...
    <button class="btn btn-success my-2"><a href="users_got_job.html" class="text-light">Who all got job</a></button>
    <button class="btn btn-warning my-2"><a href="peding_jobs.html" class="text-light">Pending jobs</a></button>
