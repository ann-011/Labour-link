...
// Fetch job details from the job_postings table using job_id
$job_id = isset($_GET['job_id']) ? $_GET['job_id'] : ''; // Assuming job_id is passed via GET
$job_query = "SELECT job_title, description, openings, wage, posted_by FROM job_postings WHERE job_id = '$job_id'";
...
<head>
    ...
    <title>Painter Job Details</title>
    <style>
        body {
