...
<link rel="stylesheet" href="display.css">
  ...
  <div class="container">
    ...
    <button class="btn btn-success my-2"><a href="diplay_got_job.php" class="text-light">Who all got job</a></button>
    <button class="btn btn-warning my-2"><a href="pending_jobs.php" class="text-light">Pending jobs</a></button>
        ...
        if ($result1) {
          while ($row1 = mysqli_fetch_assoc($result1)) {
            ...
            echo '<tr>
                    ...
                    <td>
                      <button><a href="update.php?updateid='.$id1.'">Allow</a></button>
                      <button><a href="delete.php?deleteid='.$id1.'">Delete</a></button>
                    </td>
                  </tr>';
          }
        }
        ...
        if ($result2) {
          while ($row2 = mysqli_fetch_assoc($result2)) {
            ...
            echo '<tr>
                    ...
                    <td>
                      <button><a href="update.php?updateid='.$id2.'">Allow</a></button>
                      <button><a href="delete.php?deleteid='.$id2.'">Delete</a></button>
                    </td>
                  </tr>';
          }
        }
